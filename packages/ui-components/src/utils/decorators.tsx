...
export const withInfoDecorator = (
  Component: (React.ComponentType<any> | StyledComponentClass<any, Theme, any>) & IDependencies,
  options?: WithInfoOptions) => (story: RenderFunction, context: object) => withInfo({
    text: Component.dependencies ? createDependencies(Component.dependencies) : undefined,
    ...options,
  })(story)(context);
