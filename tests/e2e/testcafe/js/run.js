...
function exitHandler(terminationLevel) {
    if (showMessageOnExit && !exitMessageShown) {
        ...
        process.on('exit', function () { return console.log('TestCafe stopped'); });
    }
...
function runTests() {
    return __awaiter(this, void 0, void 0, function () {
        var failed, testCafe, runner;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    failed = 0;
                    return [4 /*yield*/, createTestCafe()];
                case 1:
                    testCafe = _a.sent();
                ...
                case 3:
                    failed = _a.sent();
                    return [3 /*break*/, 6];
                case 4: return [4 /*yield*/, testCafe.close()];
                case 5:
                    _a.sent();
                    return [7 /*endfinally*/];
                case 6:
