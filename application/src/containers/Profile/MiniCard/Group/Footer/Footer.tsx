...
class ProfileMiniCardGroupFooterComponent extends Component<Props> {
  onClickMessage = () => {
    const { id } = this.props;
...
const ProfileMiniCardGroupFooter = translate('translations')(
  ProfileMiniCardGroupFooterComponent,
);

export { ProfileMiniCardGroupFooter };
