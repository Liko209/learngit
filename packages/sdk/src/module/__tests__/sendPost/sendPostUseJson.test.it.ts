...
itForSdk(
  'Send post test',
  ({ data, sdk, currentUserId, mockResponse, createErrorResponse, readJson }) => {
    ...
    describe('PostService', () => {
      ...
      it('send post 1: success', async () => {
        const mockInfo = mockResponse(readJson<IGlipPostPost>(require('./data/SEND_POST.SUCCESS.json')), (data) => {
          // modify the response
