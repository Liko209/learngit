...
const encodeAtMentionTags = '&lt;a class=&#x27;at_mention_compose&#x27; rel=&#x27;{&quot;id&quot;:123445}&#x27;&gt;@alvin&lt;/a&gt;';
const decodeAtMentionTags = "<a class='at_mention_compose current' href='javascript:void(0)' id=123445>alvin</a>";
...
describe('handleAtMentionName()', () => {
  it('should return decode tags if encode tags provided', () => {
    expect(handleAtMentionName(encodeAtMentionTags, { 123445: 'alvin' }, 123445)).toBe(decodeAtMentionTags);
  });
  ...
  it('should return encode tags if tags is not at mention tags', () => {
    expect(handleAtMentionName(encodeTags, { 123445: 'alvin' }, 123445)).toBe(encodeTags);
  });
});
