...
type IJuiConversationPageHeader = React.Component<JuiConversationPageHeaderProps> & IDependencies;

class JuiConversationPageHeader extends React.Component<JuiConversationPageHeaderProps, { showTooltip: boolean }> implements IJuiConversationPageHeader {
