 ...
 * @Last Modified time: 2019-02-14 16:55:26
 */
...
test(formalName('Only admin has the ability to remove members from the team', ['JPT-1081', , 'P1', 'Potar.he']), async (t) => {
  ...
  await h(t).withLog(`Given I login Jupiter with ${admin1.company.number}#${admin1.extension}`, async () => {
