...
import { TeamsSettingHandler } from '../TeamsSettingHandler';
...
describe('TeamsSettingHandler', () => {
  let profileService: ProfileService;
  let accountService: AccountService;
  let settingHandler: TeamsSettingHandler;
  ...
  function setUp() {
    ...
    settingHandler = new TeamsSettingHandler(profileService);
