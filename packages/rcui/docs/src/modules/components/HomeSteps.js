...
import FileDownloadIcon from "./svgIcons/FileDownload";
...
function HomeSteps(props) {
  ...
  return (
    <Grid container>
      <Grid
        ...
        xs={12}
        md={4}
        className={classNames(classes.step, classes.leftStep)}
      >
  ...
  \`\`\`
      ...
      <Grid
        ...
        xs={12}
        md={4}
        className={classNames(classes.step, classes.rightStep)}
      >
        <div className={classes.stepTitle}>
